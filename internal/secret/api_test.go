...
func TestAPI(t *testing.T) {
	...
	repo := &mockRepository{items: []entity.Secret{
		{ID: "123", Identifier: "test1", EncryptedData: "secret123", CreatedAt: time.Now(), UpdatedAt: time.Now()},
	}}
	...
	tests := []test.APITestCase{
		...
		{Name: "create ok", Method: "POST", URL: "/secrets", Body: `{"raw_data":"test"}`, Header: header, WantStatus: http.StatusCreated, WantResponse: "*test*"},
